    ...
    <div class="continuous-table">
      <div class="table-conten">
        <vxe-table
            ...
            <vxe-table-column field="age" title="每台手术必须清洁物品"></vxe-table-column>
            <vxe-table-column field="age" title="手术时使用过的需 要清洁的消毒物品"></vxe-table-column>
            <vxe-table-column field="age" title="每台手术后需要 重点清洁消毒物品"></vxe-table-column>
            <vxe-table-column field="age" title="如果有污染 及时清洁消毒"></vxe-table-column>
            <vxe-table-column field="age" title="进手术室时间"></vxe-table-column>
            <vxe-table-column field="age" title="出手术室时间"></vxe-table-column>
        </vxe-table>
      </div>
    </div>
</template>
