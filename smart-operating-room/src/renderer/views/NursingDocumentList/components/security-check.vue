  ...
  >
    <div class="wenben-content">
      ...
      <div class="wenben-content-context">
        <div class="before-anesthesia">
          <div class="title">
            麻醉实施前
          </div>
          <div class="info-isTrue">
            <div class="info-one">
        ...
        <div class="before-leaveroom">
          ...
          <div class="info-isTrue">
            ...
            />
            <div class="info-one">
              <span class="info-left padl5">手术部位、体位、标识正确：</span>
              <span class="info-right-one">
                <InfoList
