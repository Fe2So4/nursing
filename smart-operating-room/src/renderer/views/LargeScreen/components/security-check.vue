  ...
  <div class="security-check">
    <div class="title">
      ...
      <span class="security-voice">
        <span class="el-icon-microphone" @click="handleSpeak" />
        <span class="el-icon-turn-off-microphone" @click="handleStopSpeak" />
      </span>
    </div>
    <div class="nav">
...
import { startSpeak, cancelSpeak, isSpeaking } from "@/utils/voiceSpeak";
...
export default {
  ...
  created() {
    this.voice = window.speechSynthesis.speaking;
  },
  mounted() {
    this.getSignInInfo();
    this.getTimeOutInfo();
