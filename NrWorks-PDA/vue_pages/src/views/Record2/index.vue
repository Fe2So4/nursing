  ...
  <div class="record2">
    ...
    <div class="list">
      ...
      <van-cell-group style="margin-top: 15px">
        <van-cell title="手术类型：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.opsType"
                :options="typeOptions"
              />
            </van-dropdown-menu>
          </template>
        </van-cell>
        <van-cell title="术前意识评估：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
        ...
        <van-cell title="术前皮肤评估：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.skin.skinName"
                :options="skinOptions"
              />
            </van-dropdown-menu>
          </template>
      ...
      <van-cell-group>
        ...
        <van-cell title="约束带：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.constraints"
        ...
        <van-cell title="导尿管：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.catheter.catheterName"
        ...
        <div
          v-show="
            recordForm.catheter.catheterName === '2' ||
            recordForm.catheter.catheterName === '3'
          "
        >
          <van-cell
            title="型号："
          ...
          <div style="padding: 0 16px">
            ...
            >
              <img
                :src="recordForm.catheter.catheterSign"
                alt=""
        ...
        <van-cell
          title="电切功率："
          value=""
          v-show="recordForm.electrotome.electrotomeName === '2'"
        >
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.electrotome.electrotomeDQ"
                :options="wOptions"
              />
            </van-dropdown-menu>
          </template>
        ...
        >
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.electrotome.electrotomeDN"
                :options="wOptions"
              />
            </van-dropdown-menu>
          </template>
        ...
        <van-cell title="电极板位置：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.equipment.electrotomeLocation"
                :options="djbOptions"
              />
            </van-dropdown-menu>
          </template>
        ...
        <div v-show="recordForm.bhMachine.bhMachineName === '2'">
          <template v-for="(item, index) in recordForm.bhMachine.bhMachineList">
            ...
            <van-cell
              ...
              title=""
              v-show="
                recordForm.bhMachine.bhMachineList[index].locateName !== ''
              "
            >
              <template #right-icon>
                <van-dropdown-menu active-color="#3478FF">
                  <van-dropdown-item
                    v-model="item.presure"
                    :options="presureOptions"
                  />
                </van-dropdown-menu>
              </template>
            </van-cell>
            <van-cell
              :key="'presureValue' + index"
              :title="item.presure"
              v-show="recordForm.bhMachine.bhMachineList[index].presure !== ''"
            >
              <template #right-icon>
                <van-dropdown-menu active-color="#3478FF">
                  <van-dropdown-item
                    v-model="item.presureValue"
                    :options="presureValueList"
                  />
                </van-dropdown-menu>
              </template>
            </van-cell>
          ...
          <template v-for="(item, index) in recordForm.bhMachine.bhMachineList">
            ...
            <van-cell
              ...
              :key="'cq' + index"
              :value="
                formatTime(recordForm.bhMachine.bhMachineList[index].cqTime)
              "
              @click="handleShowTime('cqTime' + index)"
            >
            </van-cell>
            <van-cell
              title="签名"
            ...
            <van-cell
              title="放气时间"
              :key="'fq' + index"
              @click="handleShowTime('fqTime' + index)"
              :value="
                formatTime(recordForm.bhMachine.bhMachineList[index].fqTime)
              "
            >
            </van-cell>
            <van-cell
        ...
        <div v-show="recordForm.waistPuncture.waistPunctureName === '2'">
          ...
          >
            ...
            >
              <img
                :src="recordForm.waistPuncture.operationDoc"
                alt=""
                class="signatureImage"
              />
            </div>
          ...
          >
            ...
            >
              <img
                :src="recordForm.waistPuncture.needleHeartSign"
                alt=""
                class="signatureImage"
              />
            </div>
          ...
          <van-cell
            ...
            :value="formatTime(recordForm.waistPuncture.needleTime)"
          ></van-cell>
          <van-cell
            title="签名"
            title-class="sign-title"
          ...
          >
            ...
            >
              <img
                :src="recordForm.waistPuncture.needleSign"
                alt=""
                class="signatureImage"
              />
            </div>
        ...
        <van-cell title="术中冰冻：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.frozen.frozenName"
                :options="constraintOptions"
              />
            </van-dropdown-menu>
          </template>
        ...
        <van-cell title="病理：" value="">
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
                v-model="recordForm.pathology.pathologyName"
                :options="constraintOptions"
              />
            </van-dropdown-menu>
          </template>
        ...
        <van-cell
          title="数量："
          v-show="recordForm.pathology.pathologyName === '2'"
        >
          <template #right-icon>
            <van-dropdown-menu active-color="#3478FF">
              <van-dropdown-item
        ...
        >
          ...
          >
            <img
              :src="recordForm.pathology.sendDoc"
              alt=""
              class="signatureImage"
            />
          </div>
      ...
      <van-cell-group class="sign-area">
        ...
        <div style="padding: 0 16px" v-if="recordForm.nursesSignature !== ''">
          ...
          >
            <img
              :src="recordForm.nursesSignature"
              alt=""
              class="signatureImage"
            />
          </div>
        ...
        <van-cell title="术中交接班">
          <template #right-icon>
            <van-dropdown-menu
              active-color="#3478FF"
              direction="up"
              class="van-dropdown-menu__title_top"
            >
              <van-dropdown-item
        ...
        <template v-for="(item, index) in recordForm.opsChange.opsChangeList">
          <van-cell
            ...
            title="时间"
            :key="'time' + index"
            :value="formatTime(recordForm.opsChange.opsChangeList[index].time)"
            @click="handleShowTime('opsChangeList' + index)"
          ></van-cell>
          <van-cell
            v-show="recordForm.opsChange.opsChangeName === '2'"
            title="交班人签名"
          ...
          <div
            ...
            v-if="
              ...
              recordForm.opsChange.opsChangeList[index].jiaobrSign !== ''
            "
            :key="'jiebr' + index"
          >
            <div
            ...
            >
              <img
                :src="recordForm.opsChange.opsChangeList[index].jiaobrSign"
                alt=""
                class="signatureImage"
              />
            </div>
          ...
          <div
            ...
            v-if="
              recordForm.opsChange.opsChangeName === '2' &&
              recordForm.opsChange.opsChangeList[index].jiebrSign
            "
            :key="'jbr' + index"
          >
            <div
            ...
            >
              <img
                :src="recordForm.opsChange.opsChangeList[index].jiebrSign"
                alt=""
                class="signatureImage"
              />
            </div>
